# autovideo-master - Nhạc trưởng điều phối AI Video Editing

Hệ thống dựng và biên tập video tự động bằng AI, hoạt động độc lập và điều khiển 100% bằng câu lệnh thoại tiếng Việt tự nhiên trong chat. Tương thích với Codex, Antigravity, Cursor, Windsurf.
